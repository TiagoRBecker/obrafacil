...
var CreatetSettingsUseCase_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CreatetSettingsUseCase = void 0;
...
let CreatetSettingsUseCase = CreatetSettingsUseCase_1 = class CreatetSettingsUseCase {
    constructor(settingsRepository) {
        this.settingsRepository = settingsRepository;
        this.logger = new common_1.Logger(CreatetSettingsUseCase_1.name);
    }
    async execute(input, userId) {
        ...
        return settings_mapper_1.SettingsMapper.toResponse(data);
    }
};
exports.CreatetSettingsUseCase = CreatetSettingsUseCase;
exports.CreatetSettingsUseCase = CreatetSettingsUseCase = CreatetSettingsUseCase_1 = __decorate([
